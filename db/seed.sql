...
-- Departamentos
INSERT INTO departamentos (id, nome, orcamento, localizacao, data_criacao, descricao)
VALUES
  ('11111111-1111-1111-1111-111111111111', 'TI', 850000.00, 'São Paulo - SP', '2020-01-10', 'Departamento de Tecnologia da Informação'),
  ('22222222-2222-2222-2222-222222222222', 'Marketing', 450000.00, 'São Paulo - SP', '2020-02-15', 'Departamento de Marketing e Comunicação'),
  ('33333333-3333-3333-3333-333333333333', 'Vendas', 650000.00, 'Rio de Janeiro - RJ', '2020-03-05', 'Departamento de Vendas e Negócios'),
  ('44444444-4444-4444-4444-444444444444', 'RH', 350000.00, 'São Paulo - SP', '2020-03-20', 'Departamento de Recursos Humanos'),
  ('55555555-5555-5555-5555-555555555555', 'Financeiro', 400000.00, 'São Paulo - SP', '2020-04-10', 'Departamento Financeiro')
